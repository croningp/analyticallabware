...
from AnalyticalLabware.devices.Advion.advion_cms import (InstrumentController,
                                                         SimulatedInstrument,
                                                         USBInstrument)
...
def test_ignore_remaining_pumpdown_time(instrument: Union[SimulatedInstrument, USBInstrument]):
    assert instrument.ignore_remaining_pumpdown_time() is None

def test_pumpdown_remaining_seconds(instrument: Union[SimulatedInstrument, USBInstrument]):
